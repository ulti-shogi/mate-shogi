...
window.addEventListener('DOMContentLoaded', () => {
    Promise.all([
        fetch('result_2026.csv').then(res => { if(!res.ok) throw new Error('result_2026.csv失敗'); return res.text(); }),
...
function renderHistoryTable() {
    ...
    statsCard.innerHTML = `2026年度成績： ${pData.wins}勝 ${pData.losses}敗 （勝率 ${rateStr}）`;
